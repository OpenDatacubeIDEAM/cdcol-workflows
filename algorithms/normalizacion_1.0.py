...
for band in range(len(Bands)):
    ...
    if not rasterBands2[band].any():
        sys.exit(1)
# Calculo de imagen de cambios entre la imagen de referencia y la imagen 
# objetivo, seleccionando el mejor delta de cambio.
while current_iter < max_iters:
    try:
        ...
        # ending the iteration current_iter = max_iters
