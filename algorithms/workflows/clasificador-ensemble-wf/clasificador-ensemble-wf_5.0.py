...
print('tipo ImgResultado ')


print(type(ImgResultado))
...
valores = {"kmeans": xr.DataArray(ImgResultado, dims=dimensiones, coords=coordenadas)}
...
#        dimensiones.append(coordenada)
#        xcords[coordenada] = xarr0.coords[coordenada]
#valores = {"kmeans": xr.DataArray(result, dims=dimensiones, coords=coordenadas)}
#Genera el dataset (netcdf) con las bandas con el sistema de referencia de coordenadas
...
R_Error= (Err/ImgResultado)*100

####Fin de test de errores
...
print('asignacion result 6')

valores = {"error": xr.DataArray(R_Error, dims=dimensiones, coords=coordenadas)}
#Genera el dataset (netcdf) con las bandas con el sistema de referencia de coordenadas
output = xr.Dataset(valores, attrs={'crs': xarr0.crs})
