...
args = {
    ...
    'execID':"mp.mancipe10-paso-6-mosaico-k-means-utils",
    'product':_params['products'][0]
}

dag = DAG(
    dag_id='mp.mancipe10-paso-6-mosaico-k-means-utils', default_args=args,
...
mosaico = dag_utils.OneReduce(medianas, algorithm="joiner", version="1.0",  queue='airflow_medium', dag=dag, taxprefix="mosaic")
