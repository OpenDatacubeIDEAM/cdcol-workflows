...
args = {
    ...
    'execID': "compuestoDeMedianasMultiUnidad",
    'product': "Multiple"
}

dag = DAG(
    dag_id='compuesto_de_medianas_multiunidad', default_args=args,
...
joins = dag_utils.reduceByTile(maskedLS7 + maskedLS8, algorithm="joiner-reduce", version="1.0", dag=dag,
                               taxprefix="joined")
