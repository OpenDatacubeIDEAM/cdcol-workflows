...
evi = dag_utils.IdentityMap(medianas, algorithm=_steps['evi']['algorithm'],
                             version=_steps['evi']['version'],
                             queue=_steps['evi']['queue'],
                             delete_partial_results=_steps['evi']['del_prev_result'], dag=dag,
                             task_id="evi", to_tiff= not _params['genera_mosaico'])
