...
nbr = dag_utils.IdentityMap(medianas, algorithm=_steps['nbr']['algorithm'],
                             version=_steps['nbr']['version'],
                             queue=_steps['nbr']['queue'],
                             delete_partial_results=_steps['nbr']['del_prev_result'], dag=dag,
                             task_id="nbr", to_tiff= not (_params['genera_mosaico'] and queue_utils.get_tiles(_params['lat'],_params['lon'])>1))
