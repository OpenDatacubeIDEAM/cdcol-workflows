...
ndwi = dag_utils.IdentityMap(medianas, algorithm=_steps['ndwi']['algorithm'],
                             version=_steps['ndwi']['version'],
                             queue=_steps['ndwi']['queue'],
                             delete_partial_results=_steps['ndwi']['del_prev_result'], dag=dag,
                             task_id="ndwi", to_tiff= not (_params['genera_mosaico'] and queue_utils.get_tiles(_params['lat'],_params['lon'])>1))
